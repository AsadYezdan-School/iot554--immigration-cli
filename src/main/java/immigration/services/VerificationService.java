...
public class VerificationService {
     ...
     *
     * <p>Validates organisation eligibility, code format, expiry, date of birth, and purpose
     * before returning a role-appropriate outcome. Codes are reusable within their validity window.
     * Always writes an audit event.</p>
     *
